...
CREATE TABLE Shows (
  ...
  HostID INT,
  -- Foreign key referencing Hosts table
  StationID INT,
  -- Foreign key referencing Stations table
  LaunchDate DATE,
...
CREATE TABLE Awards (
  ...
  Year INT,
  ShowID INT,
  -- Foreign key referencing Shows table
...
INSERT INTO
  HOSTS (HostID, HostName, ShowCount, JoinDate)
VALUES
...
INSERT INTO
  Shows (ShowID, ShowName, HostID, StationID, LaunchDate)
VALUES
  (
    1,
  ...
  (
    3,
    'Dhun Badal Ke Toh Dekho Season 1 (with Vidya Balan)',
    4,
    3,
    '2019-01-01'
  ),
...
INSERT INTO
  ShowPartnerships (ShowID, PartnershipID)
VALUES
  (1, 1),
  -- ShowID 1 associated with PartnershipID 1
  (2, 2),
  -- ShowID 2 associated with PartnershipID 2
  (3, 3),
  -- ShowID 3 associated with PartnershipID 3
  (4, 4),
  -- ShowID 4 associated with PartnershipID 4
  (5, 5),
  -- ShowID 5 associated with PartnershipID 5
  (6, 6);

-- ShowID 6 associated with PartnershipID 6
INSERT INTO
  Awards (AwardID, AwardName, Year, ShowID)
VALUES
  (1, 'IRF Gold', 2019, 1),
  -- Award for ShowID 1 in the year 2019
  (2, 'IRF Gold', 2018, 2),
  -- Award for ShowID 2 in the year 2018
  (3, 'ABBY', 2017, 3),
  -- Award for ShowID 3 in the year 2017
  (4, 'NYF Radio Award', 2014, 4),
  -- Award for ShowID 4 in the year 2014
  (5, 'Indian Radio Forum Gold', 2019, 5),
  -- Award for ShowID 5 in the year 2019
  (6, 'Indian Radio Forum Gold', 2018, 6);

-- Award for ShowID 6 in the year 2018
INSERT INTO
  OnlinePresence (PresenceID, PlatformName, Link, LaunchDate)
VALUES
  (
    1,
    'Spotify',
    'https://open.spotify.com/bigfm',
    '2020-01-01'
  ),
  (
    2,
    'Gaana',
    'https://gaana.com/bigfm',
    '2020-01-01'
  ),
  (
    3,
    'JioSaavn',
    'https://www.jiosaavn.com/bigfm',
    '2020-01-01'
  ),
  (
    4,
    'Hungama Music',
    'https://www.hungama.com/bigfm',
    '2021-10-01'
  ),
  (
    5,
    'BIG Living Shop',
    'https://bigliving.shop',
    '2023-01-01'
  );
